...
<?php
echo ( $config['action'] ) ? $config['action'] : '<form action="'.JRoute::_( 'index.php?option=com_cck'.$itemId ).'" autocomplete="off" method="get" id="'.$formId.'" name="'.$formId.'">';
echo '<div class="cck_module_search'.$class_sfx.'">' . $form . '</div>';
?>
