...
$variations	=	'index.php?option='.CCK_COM.'&task=box.add&tmpl=component&file=administrator/components/com_cck/views/cck/tmpl/variations.php';
	...
	<thead>
		<tr>
			...
			<th width="10%" class="center hidden-phone nowrap">
				<?php echo '#&nbsp;' . JText::_( 'COM_CCK_VARIATIONS' ).' <a class="cbox" href="'.$variations.'">'
						.  '<img style="position:relative; top:-2px;" src="components/'.CCK_COM.'/assets/images/18/icon-18-download.png" border="0" alt="" /></a>'; ?>
			</th>
	...
	foreach ( $this->items as $i=>$item ) {
		...
		<tr class="row<?php echo $i % 2; ?>" height="64px;">
			...
			<td width="30px" class="center hidden-phone">
            	<a class="cbox" href="<?php echo $link2; ?>"><img src="components/<?php echo CCK_COM; ?>/assets/images/24/icon-24-templates.png" border="0" alt="" title="<?php echo $title2 ?>" /></a>
			</td>
			<td>
