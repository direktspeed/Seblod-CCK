...
<div class="modal hide fade" id="<?php echo $target_id; ?>">
	...
	<div class="modal-footer">
		<button class="btn btn-mini btn-success pull-left" type="button" onclick="window.open('http://www.seblod.com/download.html?tmpl=component', 'targetWindow', 'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=685,height=600'); return false;">
