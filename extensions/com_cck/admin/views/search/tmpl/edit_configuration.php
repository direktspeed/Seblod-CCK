...
<div class="<?php echo $this->css['wrapper']; ?>">
	<div class="seblod">
        ...
        <ul class="adminformlist adminformlist-2cols">
			...
			echo JCckDev::renderForm( $cck['core_cache'], @$options['cache'], $config, array( 'label'=>'CACHE_SEARCH' ) );
			echo JCckDev::renderForm( $cck['core_dev_text'], @$options['stages_optional'], $config, array( 'label'=>'Optional Stages', 'size'=>8,
																										   'storage_field'=>'options[stages_optional]' ) );
	...
	<div class="seblod">
        ...
        <ul class="adminformlist adminformlist-2cols">
            ...
            echo JCckDev::renderForm( 'core_show_hide', @$options['show_form'], $config, array( 'defaultvalue'=>1, 'label'=>'CONFIG_SHOW_SEARCH_FORM', 'storage_field'=>'options[show_form]' ) );
