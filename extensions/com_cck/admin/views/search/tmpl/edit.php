...
$ajax_load	=	'components/com_cck/assets/styles/'.JCck::getUser_Value( 'preferences_style', 'indigo_dye' ).'/images/ajax.gif';
$config		=	JCckDev::init( array( '42', 'jform_accesslevel', 'select_simple', 'text', 'wysiwyg_editor' ), true, array( 'item'=>$this->item, 'vName'=>$this->vName ) );
...
$style		=	JCck::getUser_Value( 'preferences_style', 'indigo_dye' );
	...
	<div class="seblod first">
    	<div>
            ...
            <ul class="spe spe_description">
                <?php echo JCckDev::renderForm( $cck['core_description'], $this->item->description, $config ); ?>
            </ul>
            <ul class="spe spe_state">
                <?php echo JCckDev::renderForm( $cck['core_state'], $this->item->published, $config ); ?>
            </ul>
        </div>
		<div class="clr"></div>
        <div class="togglebar">
