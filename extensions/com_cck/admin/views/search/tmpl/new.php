			...
			(function ($){
				JCck.Dev = {
					submit: function() {
						...
						var url = "index.php?option=com_cck&task=search.add&splash_screen="+splash_screen+"&content_type="+content_type+"&tpl_s="+tpl_s+"&tpl_f="+tpl_f+"&tpl_l="+tpl_l+"&tpl_i="+tpl_i;
