...
<div class="<?php echo $this->css['wrapper']; ?> hidden-phone">
    <div class="<?php echo $this->css['w66']; ?>">
	...
	<?php if ( JCck::on() ) {
        ...
        ?>
        <div class="<?php echo $this->css['w33']; ?>">
            <div class="well well-small">
                <div class="module-title nav-header"><?php echo JText::_( 'COM_CCK_PANE_MORE' ); ?></div>
                <div class="row-striped">
                    <?php foreach ( $more as $k=>$v ) { ?>
                        <div class="row-fluid">
                            <div class="span12">
                                <a target="_blank" href="http://www.seblod.com/products?seb_item_category=<?php echo $v; ?>"><i class="icon-download"></i>
                                <span><?php echo JText::_( 'COM_CCK_PANE_MORE_'.$k ); ?></span></a>
                            </div>
                        </div>
                    <?php } ?>
                </div>
