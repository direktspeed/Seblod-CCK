...
{	
	...
	public static function addStyleSheets( $component, $paths = array() )
	{
		...
		JHtml::_( 'stylesheet', 'administrator/components/'.CCK_COM.'/assets/styles/'.JCck::getUser_Value( 'preferences_style', 'indigo_dye' ).'/ui.css', array(), false );
	...
	public static function addValidation( $rules, $options, $id = '', &$config = array() )
	{
		...
		$doc->addScript( JURI::root( true ).'/media/cck/js/cck.validation-3.1.0.min.js' );
