...
class Helper_Workshop
{
	...
	public static function displayHeader( $element, $master )
	{
		...
		?>
            ...
            <ul class="sortable_header" myid="1">
                ...
                <?php
                if ( $master == 'content' ) { ?>
                    <div class="pane ph4 hide"><div>-</div><div><?php echo JText::_( 'COM_CCK_ACCESS' ); ?></div></div>
                    <div class="pane ph3 hide"><div><?php echo JText::_( 'COM_CCK_TYPO_LABEL' ); ?></div><div><?php echo JText::_( 'COM_CCK_TYPO' ); ?></div></div>
                    <div class="pane ph2 hide"><div><?php echo JText::_( 'COM_CCK_MARKUP_CLASS' ); ?></div><div><?php echo JText::_( 'COM_CCK_LINK' ); ?></div></div>
                ...
                <?php } else { ?>
                	<div class="pane ph6 hide"><div><?php echo JText::_( 'COM_CCK_MARKUP_CLASS' ); ?></div><div><?php echo '-'; ?></div></div>
                    ...
                    <div class="pane ph4 hide"><div><?php echo JText::_( '-' ); ?></div><div><?php echo JText::_( 'COM_CCK_ACCESS' ); ?></div></div>
        ...
        <?php
            ...
            <ul class="sortable_header" myid="1">
                ...
                <?php } else { ?>
                    <div class="pane ph6 hide"><div><?php echo JText::_( 'COM_CCK_MARKUP_CLASS' ); ?></div><div><?php echo JText::_( 'COM_CCK_REQUIRED_VALIDATION' ); ?></div></div>
	...
	{	
		...
		if ( $element == 'type' ) {
			if ( $master == 'content' ) {
                $bar		.=	'<a class="hasTooltip qtip_cck icons panel icon-one first selected" title="'.JText::_( 'COM_CCK_LABEL' ).' <b>+</b> '.JText::_( 'COM_CCK_VARIATION' ).'" href="javascript:void(0);">1</a>'
							.	'<a class="hasTooltip qtip_cck icons panel icon-two" title="'.JText::_( 'COM_CCK_LINK' ).' <b>+</b> '.JText::_( 'COM_CCK_MARKUP_CLASS' ).'" href="javascript:void(0);">2</a>'
                			.	'<a class="hasTooltip qtip_cck icons panel icon-three" title="'.JText::_( 'COM_CCK_TYPO' ).' <b>+</b> '.JText::_( 'COM_CCK_TYPO_LABEL' ).'"href="javascript:void(0);">3</a>'
							.	'<a class="hasTooltip qtip_cck icons panel icon-four" title="'.JText::_( 'COM_CCK_ACCESS' ).'" href="javascript:void(0);">4</a>';
			} else {
				$bar		.=	'<a class="hasTooltip qtip_cck icons panel icon-one first selected" title="'.JText::_( 'COM_CCK_LABEL' ).' <b>+</b> '.JText::_( 'COM_CCK_VARIATION' ).'" href="javascript:void(0);">1</a>'
							...
							.	'<a class="hasTooltip qtip_cck icons panel icon-four" title="'.JText::_( 'COM_CCK_ACCESS' ).' <b>+</b> '.JText::_( '-' ).'" href="javascript:void(0);">4</a>'
							...
							.	'<a class="hasTooltip qtip_cck icons panel icon-six" title="'.JText::_( 'COM_CCK_MARKUP_CLASS' ).'" href="javascript:void(0);">6</a>';
			}
		} else {
			if ( $master == 'content' ) {
				...
				$bar		.=	'<a class="hasTooltip qtip_cck icons panel icon-one first selected" title="'.JText::_( 'COM_CCK_LABEL' ).' <b>+</b> '.JText::_( 'COM_CCK_VARIATION' ).'" href="javascript:void(0);">1</a>'
							...
							.	'<a class="hasTooltip qtip_cck icons panel icon-six" title="'.JText::_( 'COM_CCK_REQUIRED_VALIDATION' ).' <b>+</b> '.JText::_( 'COM_CCK_MARKUP_CLASS' ).'" href="javascript:void(0);">6</a>';
			} else {
		...
		if ( $master != 'order' ) {
			$bar	.=	'<a class="hasTooltip qtip_cck icons panel icon-f first'.$last.'" title="<b>'.JText::_( 'COM_CCK_POSITIONS' ).':</b><br />'
	...
	public static function getParams( $element, $master, $client )
	{
		...
		if ( $element == 'type' ) {
			if ( $master == 'content' ) {
				...
				$data['typo_label']	=	array( JHtml::_( 'select.option', 0, JText::_( 'JNO' ) ), JHtml::_( 'select.option', 1, JText::_( 'JYES' ) ) );
				$data['access']		=	JCckDatabase::loadObjectList( 'SELECT a.id AS value, a.title AS text FROM #__viewlevels AS a GROUP BY a.id ORDER BY a.ordering ASC, title ASC' );
			} else {
				$data['client']		=	$client;
			...
			if ( isset( $xml->positions[0] ) ) {
				foreach ( $xml->positions[0] as $position ) {
					...
					if ( isset( $position->attributes()->toggle ) && (string)$position->attributes()->toggle ) {
						$val	=	$values[(string)$position->attributes()->toggle];
