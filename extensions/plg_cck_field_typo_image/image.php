...
class plgCCK_Field_TypoImage extends JCckPluginTypo
{
	...
	protected static function _addImage( &$field, $params, $root )
	{
		...
		$box_description	=	( $img_description == '' ) ? '' : $img_description;
		$img_title			=	( $img_title == '' ) ? $filename : $img_title;
		$img_description	=	( $img_description == '' ) ? ( ( $img_title == '' ) ? $filename : $img_title ) : $img_description;
