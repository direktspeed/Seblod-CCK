...
{
	protected static $type_field				=	'label, variation, variation_override, required, required_alert, validation, validation_options, link, link_options, live, live_options, live_value, markup_class, typo, typo_label, typo_options, stage, access, computation, computation_options, conditional, conditional_options, position';
	protected static $type_field_get			=	'c.label as label2, c.variation, c.variation_override, c.required, c.required_alert, c.validation, c.validation_options, c.link, c.link_options, c.live, c.live_options, c.live_value, c.markup_class, c.typo, c.typo_label, c.typo_options, c.stage, c.access, c.computation, c.computation_options, c.conditional, c.conditional_options, c.position';
	protected static $search_field				=	'label, variation, variation_override, required, required_alert, validation, validation_options, link, link_options, live, live_options, live_value, markup_class, match_collection, match_mode, match_options, match_value, typo, typo_label, typo_options, stage, access, computation, computation_options, conditional, conditional_options, position';
	protected static $search_field_get			=	'c.label as label2, c.variation, c.variation_override, c.required, c.required_alert, c.validation, c.validation_options, c.link, c.link_options, c.live, c.live_options, c.live_value, c.markup_class, c.match_collection, c.match_mode, c.match_options, c.match_value, c.typo, c.typo_label, c.typo_options, c.stage, c.access, c.computation, c.computation_options, c.conditional, c.conditional_options, c.position';
	...
	public static function gm_getConstruction_Values_Type( $k, $params, $position, $client )
	{
		...
		$values					=	'"'.$label.'", "'.$variation.'", "'.$variation_override.'", "'.$required.'", "'.$required_alert.'", "'.$validation.'", "'.$validation_options.'", '
								.	'"'.$link.'", "'.$link_options.'", "'.$live.'", "'.$live_options.'", "'.$live_value.'", "'.$markup_class.'", "'.$typo.'", "'.$typo_label.'", "'.$typo_options.'", '.$stage.', '
								.	'"'.$access.'", "'.$computation.'", "'.$computation_options.'", "'.$conditional.'", "'.$conditional_options.'", "'.$position.'"';
	...
	public static function gm_getConstruction_Values_Search( $k, $params, $position )
	{
		...
		$values					=	'"'.$label.'", "'.$variation.'", "'.$variation_override.'", "'.$required.'", "'.$required_alert.'", "'.$validation.'", "'.$validation_options.'", '
								.	'"'.$link.'", "'.$link_options.'", "'.$live.'", "'.$live_options.'", "'.$live_value.'", "'.$markup_class.'", "'.$match_collection.'", "'.$match_mode.'", "'.$match_options.'", ' 	
								.	'"'.$match_value.'", "'.$typo.'", "'.$typo_label.'", "'.$typo_options.'", '.$stage.', "'.$access.'", "'.$computation.'", '
