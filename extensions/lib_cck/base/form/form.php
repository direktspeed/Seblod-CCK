...
class CCK_Form
{
	...
	public static function getFields( $type, $client, $stage, $excluded, $idx, $cck = false )
	{
		...
		$query	=	'SELECT DISTINCT a.*, c.client,'
				.	' c.label as label2, c.variation, c.variation_override, c.required, c.required_alert, c.validation, c.validation_options, c.live, c.live_options, c.live_value, c.markup_class, c.stage, c.access, c.computation, c.computation_options, c.conditional, c.conditional_options, c.position'
	...
	{		
		...
		$query	=	'SELECT a.id, a.title, a.name, a.description, a.location, a.storage_location, b.app as folder_app,'
				.	' a.options_admin, a.options_site, a.options_content, a.options_intro, a.template_admin, a.template_site, a.template_content, a.template_intro'
