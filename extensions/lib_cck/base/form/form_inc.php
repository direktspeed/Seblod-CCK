...
if ( ! $type ) {
	$config		=	array( 'action'=>$preconfig['action'], 'formId'=>$preconfig['formId'], 'javascript'=>'', 'submit'=>$preconfig['submit'], 'validation'=>array(), 'validation_options'=>array() );
...
$templateStyle	=	CCK_Form::getTemplateStyle( $type->$P );
if ( ! $templateStyle ) {
