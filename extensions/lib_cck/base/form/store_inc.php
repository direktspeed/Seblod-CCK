...
if ( count( $fields ) ) {
	foreach ( $fields as $field ) {
		$name			=	$field->name;
		$field->state	=	'';
		if ( ( $field->variation == 'hidden' || $field->variation == 'disabled' || $field->variation == 'value' ) && ! $field->live && $field->live_value != '' ) {
		...
		if ( !$id && $field->live && ( $field->variation == 'hidden' || $field->variation == 'disabled' || $field->variation == 'value' ) ) {
