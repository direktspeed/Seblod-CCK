...
$go_for_item	=	( strpos( $templateStyle->params, '"cck_client_item":"1"' ) !== false ) ? 1 : 0;	//todo: refact + explode params later..
$go_for_both	=	( strpos( $templateStyle->params, '"cck_client_item":"2"' ) !== false ) ? 1 : 0;	//todo: refact + explode params later..
if ( $go_for_item || $go_for_both ) {
	...
	// Template
	$P					=	'template_item';
	$templateStyleItem	=	CCK_List::getTemplateStyle( $search->$P );
