...
abstract class modCCKQuickIconHelper
{
	...
	public static function &getButtons()
	{
		...
		if ( empty( self::$buttons ) ) {
			if ( $uix == 'compact' ) {
				self::$buttons	=	array(
					array( 'link'	=>	JRoute::_( 'index.php?option=com_cck&view=types' ),
					...
					array( 'link'	=>	JRoute::_( 'index.php?option=com_cck&view=folders' ),
					...
					array( 'link'	=>	JRoute::_( 'http://www.seblod.com/products' ),
						   'target'	=>	'_blank',
						   'icon'	=>	'icon-48-seblod.png',
						   'image'	=>	'cart',
						   'label' 	=>	JText::_( 'MOD_CCK_QUICKICON_SEBLOD_MARKET' ),
						   'text' 	=>	str_replace( '<br />', ' ', JText::_( 'MOD_CCK_QUICKICON_SEBLOD_MARKET' ) ),
						   'access'	=>	array( 'core.manage', 'com_cck' )
						)
				);
			} else {
				self::$buttons	=	array(
					...
					array( 'link'	=>	JRoute::_( 'index.php?option=com_cck&view=fields' ),
					...
					array( 'link'	=>	JRoute::_( 'index.php?option=com_cck&view=searchs' ),
					...
					array( 'link'	=>	JRoute::_( 'index.php?option=com_cck&view=templates' ),
					...
					array( 'link'	=>	JRoute::_( 'index.php?option=com_cck&view=sites' ),
