...
<div class="seblod">
    ...
    <ul class="adminformlist adminformlist-2cols">
		...
		echo JCckDev::renderForm( 'core_options_path_content', @$options2['path_content'], $config );
		...
		for ( $i = 2; $i < 11; $i++ ) {
			...
			echo '<li><label>'.JText::_( 'COM_CCK_WIDTH_HEIGHT' ).'</label>'
		 	 ...
		 	 .	 '<span class="variation_value">px</span></li>';
		 	 $js	.=	'$("#json_options2_thumb'.$i.'_width").isVisibleWhen("json_options2_thumb'.$i.'_process","addcolor,crop,maxfit,shrink,stretch,stretch_dynamic,shrink_dynamic",true,"visibility");'."\n";
		}
...
jQuery(document).ready(function($) {
	...
	$('#json_options2_image_width').isVisibleWhen('json_options2_image_process','addcolor,crop,maxfit,shrink,stretch,stretch_dynamic,shrink_dynamic',true,'visibility');
	$('#json_options2_thumb1_width').isVisibleWhen('json_options2_thumb1_process','addcolor,crop,maxfit,shrink,stretch,stretch_dynamic,shrink_dynamic',true,'visibility');
	<?php echo $js; ?>
