...
<div class="seblod">
    ...
    <ul class="adminformlist adminformlist-2cols">
		...
		.	 JCckDev::getForm( 'core_dev_text', @$options2['attr1'], $config, array( 'size'=>8, 'storage_field'=>'json[options2][attr1]' ) )
		.	 JCckDev::getForm( 'core_dev_text', @$options2['attr2'], $config, array( 'size'=>8, 'storage_field'=>'json[options2][attr2]' ) )
		...
		.	 JCckDev::getForm( 'core_dev_text', @$location[0], $config, array( 'size'=>8, 'storage_field'=>'string[location][]' ) )
		.	 JCckDev::getForm( 'core_dev_text', @$location[1], $config, array( 'size'=>8, 'storage_field'=>'string[location][]' ) )
